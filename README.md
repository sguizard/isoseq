...
**nf-core/isoseq** is a bioinformatics best-practice analysis pipeline for Isoseq annotation pipeline using uLTRA and TAMA.
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```console
    nextflow run nf-core/isoseq -profile test,<docker/singularity/podman/shifter/charliecloud/conda/institute>
    ```
...
4. Start running your own analysis!
    ...
    ```console
    nextflow run nf-core/isoseq --input path_to/bam_dir/ --fasta galgal6.fa --primers primers.fa --run-cluster -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
    ```
